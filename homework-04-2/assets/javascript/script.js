document.addEventListener("DOMContentLoaded", function (event) {  
    ...
    instructions.textContent = ("GRADING CRITERIA: Your score is the number of correct answers times "+problemTime+", plus the time remaining. Careful - wrong answers will also subtract "+penalty+" seconds from the time remaining!");
